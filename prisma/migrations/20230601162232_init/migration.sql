...
-- AddForeignKey
ALTER TABLE `online_consultations` ADD CONSTRAINT `online_consultations_chatId_fkey` FOREIGN KEY (`chatId`) REFERENCES `chats`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
